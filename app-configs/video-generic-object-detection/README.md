# IoTConnect-Enabled: video-generic-object-detection
...
![video-generic-object-detection dashboard](img-det-video-dashboard.png)

Dashboard template file: [$(UnoQobjectDetectionwithCamera_dashboard_export.json.Name)](UnoQobjectDetectionwithCamera_dashboard_export.json)
...
2) Copy the /IOTCONNECT-enabled python files into the app:
   ```bash
   cp /home/arduino/iotc-arduino-uno-q-workshop/app-configs/video-generic-object-detection/python/* /home/arduino/ArduinoApps/detect-objects-on-camera/python/
   cp /opt/demo/iotc_relay_client.py /home/arduino/ArduinoApps/detect-objects-on-camera/python/
   ```

...
Dashboard template file: [UnoQobjectDetectionwithCamera_dashboard_export.json](UnoQobjectDetectionwithCamera_dashboard_export.json)
...
2) Copy the /IOTCONNECT-enabled python files into the app:
   ```bash
   cp /home/arduino/iotc-arduino-uno-q-workshop/app-configs/video-generic-object-detection/python/* /home/arduino/ArduinoApps/<APP_LAB_FOLDER>/python/

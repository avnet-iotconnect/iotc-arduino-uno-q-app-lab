...
![audio-classification dashboard](unoq-dashboard-audioclass.jpg)

Dashboard template file: [audio-unoq-dasboard.json](audio-unoq-dasboard.json)
...
2) Copy the /IOTCONNECT-enabled python files into the app:
   ```bash
   cp /home/arduino/iotc-arduino-uno-q-workshop/app-configs/audio-classification/python/* /home/arduino/ArduinoApps/<APP_LAB_FOLDER>/python/

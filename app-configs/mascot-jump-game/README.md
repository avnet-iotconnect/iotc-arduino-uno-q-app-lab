# /IOTCONNECT-Enabled: mascot-jump-game

This is the /IOTCONNECT-enabled version of the Arduino example.

Original Arduino README:
- https://github.com/arduino/app-bricks-examples/blob/main/examples/mascot-jump-game/README.md
...
2) Copy the /IOTCONNECT-enabled python files into the app:
   ```bash
   cp /home/arduino/iotc-arduino-uno-q-workshop/app-configs/mascot-jump-game/python/* /home/arduino/ArduinoApps/<APP_LAB_FOLDER>/python/

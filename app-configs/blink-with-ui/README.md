# IoTConnect-Enabled: blink-with-ui

This is the /IOTCONNECT-enabled version of the Arduino example.

Original Arduino README:
- https://github.com/arduino/app-bricks-examples/blob/main/examples/blink-with-ui/README.md
...
App Lab folder: `/home/arduino/ArduinoApps/blink-led-with-ui`
...
2) Copy the /IOTCONNECT-enabled python files into the app:
   ```bash
   cp /home/arduino/iotc-arduino-uno-q-workshop/app-configs/blink-with-ui/python/* /home/arduino/ArduinoApps/blink-led-with-ui/python/
   cp /opt/demo/iotc_relay_client.py /home/arduino/ArduinoApps/blink-led-with-ui/python/
   ```

# /IOTCONNECT Version: cloud-blink
...
2) Copy the /IOTCONNECT-enabled python files into the app:
   ```bash
   cp /home/arduino/iotc-arduino-uno-q-workshop/app-configs/cloud-blink/python/* /home/arduino/ArduinoApps/<APP_LAB_FOLDER>/python/
   ```

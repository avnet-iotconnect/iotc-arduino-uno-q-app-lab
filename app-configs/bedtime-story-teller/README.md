# /IOTCONNECT Version: bedtime-story-teller

This is the /IOTCONNECT-enabled version of the Arduino example.

Original Arduino README:
- https://github.com/arduino/app-bricks-examples/blob/main/examples/bedtime-story-teller/README.md
...
App Lab folder: `/home/arduino/ArduinoApps/bedtime-story-teller`
...
2) Copy the /IOTCONNECT-enabled python files into the app:
   ```bash
   cp /home/arduino/iotc-arduino-uno-q-workshop/app-configs/bedtime-story-teller/python/* /home/arduino/ArduinoApps/bedtime-story-teller/python/
   cp /opt/demo/iotc_relay_client.py /home/arduino/ArduinoApps/bedtime-story-teller/python/
   ```

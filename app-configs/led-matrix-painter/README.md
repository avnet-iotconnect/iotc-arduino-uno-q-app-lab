# /IOTCONNECT Version: led-matrix-painter

This is the /IOTCONNECT-enabled version of the Arduino example.

Original Arduino README:
- https://github.com/arduino/app-bricks-examples/blob/main/examples/led-matrix-painter/README.md
...
2) Copy the /IOTCONNECT-enabled python files into the app:
   ```bash
   cp /home/arduino/iotc-arduino-uno-q-workshop/app-configs/led-matrix-painter/python/* /home/arduino/ArduinoApps/led-matrix-painter/python/
   cp /opt/demo/iotc_relay_client.py /home/arduino/ArduinoApps/led-matrix-painter/python/
   ```
